 ...
 * @author Jiangqing
 * @version 1.0
 * @since 2019/11/24 16:35
 */
public class Client {
    private static int serverPort = 20000;
    private static int clientPort = 20001;
    ...
    public static void main(String[] args) throws Exception{
        ...
        socket.connect(new InetSocketAddress(Inet4Address.getLocalHost(), serverPort), 3000);
